...
int*__
#+end_src
+ Is used to emphasize that the variable being declared is a pointer of some type (i.e. int, double, short)
#+begin_src cpp
= &___
#+end_src
+ Returns/pulls the memory address of a specific variable
